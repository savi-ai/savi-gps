  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // Wait a moment to ensure tenant is stored in localStorage
        await new Promise(resolve => setTimeout(resolve, 500))
        // Verify tenant is stored before redirecting
        const tenant = localStorage.getItem('current_tenant')
        if (!tenant) {
          console.warn('Tenant not found after login, but proceeding to dashboard')
        }
        // Redirect to dashboard without tenant in URL
        router.push('/dashboard')
      } else {
        ...
        <div className="login-branding">
          <div className="login-brand-content">
            ...
            <p className="login-brand-subtitle">
              Alpha — build new software, understand existing codebases, and plan modernization
            </p>
